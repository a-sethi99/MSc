...
in_dir <- "/lustre/nobackup/WUR/ESG/sethi002/Climate Projection Output/Affected_Maps_CRP11"

out_ts <- "/lustre/nobackup/WUR/ESG/sethi002/Climate Projection Output/CRP11_Timeseries"
