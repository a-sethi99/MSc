...
event_dir <-
  "/lustre/nobackup/WUR/ESG/sethi002/1994-2024 Historical Analysis/CRP11/CRP11_GS_Precip"
...
output_file <-
  file.path(
    output_dir,
    "event_probability_CRP11_GS_Precip_1994_2024.tif"
  )
...
writeRaster(
  ...
  file.path(
    output_dir,
    "event_years_CRP11_GS_Precip_1994_2024.tif"
  ),
  overwrite = TRUE
)
