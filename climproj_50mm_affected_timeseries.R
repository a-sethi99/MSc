...
in_dir <- "/lustre/nobackup/WUR/ESG/sethi002/Climate Projection Output/Affected_Maps_50mm"

out_ts <- "/lustre/nobackup/WUR/ESG/sethi002/Climate Projection Output/50mm_Timeseries"
