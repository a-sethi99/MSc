...
# Read Excel file
df <- read_excel(
  "C:/Users/aashi/Desktop/THESIS RUN/1994-2024 Historical Analysis/30mm Results/affected_area_timeseries_30mm_94-24.xlsx"
)
...
p <- ggplot(
  ...
  labs(
    title = expression(
      bold(
      "Area (km"^2*") of Wheat Cropland affected by Indicator 1"
      )
    ),
    x = "Year",
    y = expression(
...
p2 <- ggplot(
  ...
  labs(
    title = "Percentage of Wheat Cropland Affected by Indicator 1",
    x = "Year",
    y = "Affected Area (%)"
  )
