...
affected_dir <- "C:/Users/aashi/Desktop/THESIS RUN/1994-2024 Historical Analysis/50mm_Affected_Maps"

# Output folder
output_dir <- "C:/Users/aashi/Desktop/THESIS FIRST DRAFT/era5_basin_output/50mm"
...
output_csv <- file.path(
  output_dir,
  "basin_percent_cropland_affected_50mm_1994_2024.csv"
)
